const chapter = {
  ...
  teacherInfo: {
  instructions: [
    'This sign{{IMG:/images/chapters/chapter-14/shadd.webp}}is called **Shadd**, it is written over the letter with **Harkaat**.',
    ...
    'For example:{{IMG:/images/chapters/chapter-14/shadd2.webp}}',
  ...
  imagePath: '/images/chapters/chapter-14/shadd3.webp'
},
 pageTeacherInfo: {
    2: { 
      instructions: [
...
pageTitles: {
  ...
  pages: [
    ...
    [
      ['بِكُلِّ', 'فَغُلُّوهُ', 'اٰمَنَّا', 'فَإِنَّى'],
      ['يَدُعُّ', 'سُعِّرَتْ', 'فَلَمَّا', 'وَأُمُّهُ'],
      ['مَرَّاتٍ', 'وَبُرِّزَتْ', 'سِتِّينَ', 'عَنِتُّمْ'],
      ['بِبَكَّةَ', 'سُكِّرَتْ']
    ],
    ...
    [
      ...
      ['فَبَدَّلَ', 'فَرُدُّوْهُ', 'يَصُدُّوْنَ'],
      ['وَتَرَى الشَّمْسَ', 'عَمِلُوا الصَّالِحَاتِ']
    ]
  ]
};
