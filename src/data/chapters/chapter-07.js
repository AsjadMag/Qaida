const chapter = {
  ...
  teacherInfo: {
    instructions: [
      '**Yaa-i Maddah:** If **Zair** is placed before a Sakin Yaa{{IMG:/images/chapters/chapter-07/YaaImaddah.webp}} it is called **Yaa-i Maddah**.',
      'For example:{{IMG:/images/shared/Bay.webp}}Zair{{IMG:/images/chapters/chapter-07/BaZair.webp|3rem}}And if it is pronounced twice then{{IMG:/images/shared/Bay.webp}}Zair - Yaa{{IMG:/images/chapters/chapter-07/BiYa.webp|4rem}} .'
    ],
