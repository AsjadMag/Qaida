 ...
 5: {
  ...
  8: {
    ...
    pages: [
      ...
      // For every letter+yaa combo the kasra is written after the yaa (not the
      // base letter) so the font stacks it below the yaa's two dots instead of
      // colliding with them.
      [['بيِْ', 'تيِْ', 'ثيِْ', 'جيِْ', 'حيِْ'],
      ['خيِْ', 'ديِْ', 'ذيِْ', 'ريِْ', 'زيِْ'],
      ['سيِْ', 'شيِْ', 'صيِْ', 'ضيِْ', 'طيِْ'],
      ['ظيِْ', 'عيِْ', 'غيِْ', 'فيِْ', 'قيِْ'],
      ['كيِْ', 'ليِْ', 'ميِْ', 'نيِْ', 'هيِْ'],
      ['ويِْ', 'ايِْ', 'ييِْ']],
  ...
  10: {
    ...
    [
      ...
      ['اَطِيْعُوْنيِ', 'يَقُوْلُوْنَ', 'فَتُوْبُوْا', 'وَرَابِطُوْا'],
      ['اُوْتيَِ', 'عُوْقِبَ', 'بَرَزُوْا', 'وَرَضُوْا'],
