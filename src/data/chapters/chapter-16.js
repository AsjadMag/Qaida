const chapter = {
  ...
  teacherInfo: {
    instructions: [
      ...
      '{{IMG:/images/chapters/chapter-16/chapter1_v2.webp|3rem}}',
      'If there is **Zair** before the word "**Allah\'s**" **Laam** then both **Laam** will be read in a **thin tone**.',
      '{{IMG:/images/chapters/chapter-16/chapter1_v2-1.webp|3rem}}',
      'If **Alif** comes after a **thick letter** it will be read in a **thick tone**.',
      '{{IMG:/images/chapters/chapter-16/chapter1_v2-2.webp|3rem}}',
      'If **Alif** comes after a **thin letter** it will be read **thin**.',
      '{{IMG:/images/chapters/chapter-16/chapter1_v2-3.webp|3rem}}'
    ],
