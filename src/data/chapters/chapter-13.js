const chapter = {
  ...
  teacherInfo: {
  instructions: [
    'This sign {{IMG:/images/chapters/chapter-13/Jazm or Sukoon2.webp|3rem}} is called **Jazm** or **Sukoon**, it is written over the letter.',
...
teacherImage: {
    imagePath: '/images/chapters/chapter-13/Jazm or Sukoon.webp',
    alt: 'Wao Maddah example diagram'
  }, 
pageTeacherInfo: {
    1: { // Page 2 (Total Page 31): Exercise of Jazm
      instructions: [
        '{{IMG:/images/chapters/chapter-13/Jazm or Sukoon3.webp}} if these letters have a Jazm then.',
      ...
      imagePath: '/images/chapters/chapter-13/Jazm or Sukoon4.webp',
