const chapter = {
  ...
  instructions: [
     ...
     '**When pausing at round** {{IMG:/images/chapters/chapter-26/chapter_11_v2(2).webp}} **and round** {{IMG:/images/chapters/chapter-26/chapter_11_v2(3).webp}}',
     '**it is always changed in to a sakin** {{IMG:/images/chapters/chapter-26/chapter_11_v2(3).webp}}'
    ],
    imagePath: '/images/chapters/chapter-26/chapter_11_v2.webp',
   ...
   6: {
      instructions: ['**NOTE:** If there is an inactive {{IMG:/images/chapters/chapter-26/chapter_11_v2(4).webp}} after zabar,',
        'then in case of pause it will be prolonged equivalent to one Alif.',
        '{{IMG:/images/chapters/chapter-26/chapter_11_v2(5).webp|8rem}}'
      ],
    }
  },
  pages: [
    ...
    [
      ['وَاحِدَةً ⇐ وَاحِدَهْ', 'بَقَرَةً ⇐ بَقَرَهْ', 'غَيْرِهٖ ⇐ غَيْرِهْ', 'رَسُولِهِ ⇐ رَسُولُهْ'],
      ['بِالْآخِرَةِ', 'بِسُورَةٍ', 'بَعُوضَةً', 'اَلْجَنَّةَ'],
      ['بَعْدِهِ']
    ],
    // Page 2 (Total Page 74)
    [
    ...
    // Page 6 (Total Page 78)
    [
      ['لَهُنَّ ⇐ لَهُنّ', 'اَلْغَمِّ ⇐ اَلْغَمّ', 'اَلظَّنِّ ⇐ ٱلظَّنّ', 'اَلصُّمَّ ⇐ اَلصُّمّ'],
      ['فَسَوّٰهُنَّ', 'أَليَمِّ', 'عَلَيْهِنَّ', 'بِغَمٍّ']
    ],
    // Page 7 (Total Page 79)
    [
      ['اَلْاَعْلَى ⇐ ٱلْاَعْلَىٰ', 'اَلْاَشْقَى ⇐ ٱلْاَشْقَىٰ', 'اَلْاَتْقَى ⇐ ٱلْاَتْقَىٰ', 'تَقْوَى ⇐ تَقْوَىٰ'],
      ['مَثْوَى ⇐ مَثْوَىٰ']
    ]
  ]
};
